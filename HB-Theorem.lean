...
Here we prove a scheme formalizing the Heine-Borel Theorem for subsets of [0,1] in ℝ. This will be later used to give characterization of subsets of [0,1] for which the HB theorem is equivalent to WKL0 in the big five reverse mathematics axiom systems.
-/
